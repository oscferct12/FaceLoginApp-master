...
namespace FaceLoginApp.Servicios
{
    public static class ServicioFace
    {
        ...
        public static async Task<bool> CrearGrupoEmpleados(string nombreEmpresa, string nombreArea, string descripcion)
        {
            try
            {
                
                var clienteFace = new FaceServiceClient(Constantes.FaceApiKey, Constantes.FaceApiURL);
                await clienteFace.CreatePersonGroupAsync(nombreEmpresa, nombreArea, descripcion);
                return true;
        ...
        //public static async bool CrearGrupo()
        //{
        //    var clienteFaceGrupo = new FaceServiceClient(Constantes.FaceApiKey, Constantes.FaceApiURL);
        //    await clienteFaceGrupo.CreatePersonGroupAsync(Constantes.FaceGroupID, Constantes.FaceGroupName, Constantes.FaceGroupDescription);
        //    return true;
        //}
